# 📘 2nd Year Biotech resources

Welcome to the 2nd Year Biotech Resources!  
This section contains organised study materials, lab manuals, and past question papers for each subject for both 3rd and 4th semesters
...
- [Environment & Sustainability](./Basket-Course/Environment_and_Sustainability)
- [Material Science for Engineers](./Basket-Course/Material_Science)
- [Bio safety standards and Ethics](./Basket-Course/Bio_safety_standards)

### 🗂️ Structure
Each subject folder includes:
- 📖 Notes (Unit-wise PDFs)
- 🧪 Lab Manuals (where applicable)
- 📑 Question banks (where applicable)
